...
import { aeadEncrypt, aeadDecrypt } from "../../../../src/platform/crypto/node/aead.js";
import { NodeCryptoProvider, nodeCryptoProvider } from "../../../../src/platform/crypto/node/node-crypto-provider.js";
import * as cryptoIndex from "@browsercore/crypto";
import { CryptoError, DecryptError, UnsupportedAlgorithmError, ensureCryptoError } from "@browsercore/crypto";
import { aes128Gcm, aes256Gcm, chacha20Poly1305, CIPHER_BY_ID, AES_128_CCM } from "../../../../src/platform/crypto/node/ciphers.js";
import {
    AES_128_GCM,
    AES_256_GCM,
    CHACHA20_POLY1305,
...
import { assertNever, createId } from "@browsercore/crypto";
...
describe("default singleton", () => {
    ...
    it("is a usable CryptoProvider (randomBytes works)", () => {
        const bytes = nodeCryptoProvider.randomBytes(16);
...
describe("public API (index.ts)", () => {
    it("re-exports the branded ids and errors", () => {
    ...
    it("re-exports the branded symmetric cipher and hash ids", () => {
        expect(cryptoIndex.AES_128_GCM).toBe(AES_128_GCM);
        expect(cryptoIndex.AES_256_GCM).toBe(AES_256_GCM);
