...
## Step 9 — Connection pooling + reuse
...
## Step 10 — Timeout + abort handling
...
- [ ] URL parsing rejects malformed input with a typed error.
- [ ] ALPN selects exactly one of h2 / h1.1 per connection.
- [ ] Profile applies to both TLS and HTTP layers.
- [ ] Redirect policy follows / manual / error all work; loops throw.
- [ ] Cookie jar round-trips Set-Cookie on responses.
